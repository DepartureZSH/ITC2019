...
from utils.solutionReader import PSTTReader as SolutionReader
...
class solution:
    def __init__(self, reader, solution_reader):
        self.reader = reader
...
if __name__ == "__main__":
    file = '/home/scxsz1/zsh/Learning/MARL/PSTT/data/early/muni-fi-spr16.xml'
    solution_file = '/home/scxsz1/zsh/Learning/MARL/PSTT/MIP/solutions/early/muni-fi-spr16/solution67_muni-fi-spr16.xml'
    reader = PSTTReader(file)
    solu_reader = SolutionReader(solution_file)
    solu = solution(reader, solu_reader)
    ...
    print("Total_cost", total["Total_cost"])
